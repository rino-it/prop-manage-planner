...
import { 
  ...
  LogOut, FileText, UserPlus, FolderOpen, Users, Truck // Aggiunta icona Truck
} from 'lucide-react';
...
export default function Sidebar({ activeTab, setActiveTab, onCloseMobile }: SidebarProps) {
  ...
  const menuItems = [
    ...
    // VOCE PARCO MEZZI REINSERITA
    { id: 'mobile-properties', label: 'Parco Mezzi', icon: Truck, color: 'text-slate-600' },
