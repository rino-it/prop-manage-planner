...
export default function GuestPortal() {
  ...
  // SIMULAZIONE GENERAZIONE VOUCHER (Anti-Frode)
  const handleVoucherDownload = (serviceTitle: string) => {
    ...
    alert(`[SIMULAZIONE PDF]\n\nVoucher per: ${serviceTitle}\nOspite: ${booking.nome_ospite}\nVALIDO FINO AL: ${expiryDate}\n\n(Qui si aprirà il PDF reale nel prossimo step)`);
  };
                        ...
                        <Card key={service.id} className={`overflow-hidden border-l-4 transition-shadow hover:shadow-md flex flex-col ${isPremium ? 'border-l-yellow-400' : 'border-l-green-500'}`}>
                            ...
                            <CardFooter className="mt-auto pt-0">
                                {isPremium ? (
                                    ...
                                    <Button variant="outline" className="w-full border-green-500 text-green-600 hover:bg-green-50" onClick={() => handleVoucherDownload(service.titolo)}>
